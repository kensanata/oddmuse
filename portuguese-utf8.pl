...
#
$ModulesDescription .= '<p>$Id: portuguese-utf8.pl,v 1.19 2005/01/07 23:58:49 as Exp $</p>';
%Translate = split('\n',<<END_OF_TRANSLATION);
...
Você é atualmente um administrador neste site.
You are currently an editor on this site.
Você é atualmente um editor neste site.
You are a normal user on this site.
Você é um usuario normal neste site.
Your password does not match any of the  administrator or editor passwords.
Sua senha não confere com nenhuma dos administradores ou editores.
Password:
Senha:
This site does not use admin or editor passwords.
Este site não usa senhas de administrador ou editor.
