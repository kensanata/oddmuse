...
UserName %s inválido: no ha sido guardado.
...
Listar cambios nuevos a partir de
No updates since %s
...
La base de datos se encuentra almacenada temporalmente en el directorio %s
%s seconds
%s segundos
Search:
Buscar:
...
Diferencias (de la revisión %s
 to %s)
 a la %s)
No diff available--this is the first %s revision.
No hay diffs disponibles--esta es la primera revisión %s.
...
Se ha forzado la desactivación del bloqueo %s.
No unlock required.
...
Actualmente usted es un administrador en este sitio.
You are currently an editor on this site.
Actualmente usted es un editor en este sitio.
You are a normal user on this site.
Usted es un usuario normal en este sitio.
...
Edit lock created.
Se ha creado un bloqueo de edición.
Edit lock removed.
Se ha eliminado el bloqueo de edición.
Set or Remove page edit lock
Establecer o Remover el bloqueo de edición de una página
Missing page id to lock/unlock...
No se ha encontrado ID de la página a bloquear/desbloquear...
Lock for %s created.
Se ha creado bloqueo para %s.
Lock for %s removed.
