...
#
$ModulesDescription .= '<p>$Id: bulgarian-utf8.pl,v 1.3 2005/07/02 00:02:02 as Exp $</p>';
%Translate = split('\n',<<END_OF_TRANSLATION);
...
Липсва идентификатор на страница за налагане/отмяна на защита...
Lock for %s created.
