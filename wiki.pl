...
sub GetHttpHeader {
  ...
  # provide a $ts, the generated last-modified header will be used by both HTTP/1.0 and HTTP/1.1 clients. If you
  # provide no $ts, the generated etag header will be used by HTTP/1.1 clients. In this situation, cookie parameters can
