#! /usr/bin/perl
# Version       $Id: wiki.pl,v 1.945 2011/07/06 15:37:10 as Exp $
...
$VERSION=(split(/ +/, q{$Revision: 1.945 $}))[1]; # for MakeMaker
...
sub InitVariables {  # Init global session variables for mod_perl!
  $WikiDescription = $q->p($q->a({-href=>'http://www.oddmuse.org/'}, 'Oddmuse'),
    ...
    . $q->p(q{$Id: wiki.pl,v 1.945 2011/07/06 15:37:10 as Exp $});
...
<docs>http://blogs.law.harvard.edu/tech/rss</docs>
  ...
  $rss .= qq{<atom:link href="} . $q->url(-path_info=>1,-query=>1)
